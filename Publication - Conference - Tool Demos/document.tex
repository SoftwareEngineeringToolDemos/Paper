...
\author{\IEEEauthorblockN{Emerson Murphy-Hill}
\IEEEauthorblockA{Department of Computer Science\\
North Carolina State University\\
Raleigh, North Carolina, USA\\
emerson@csc.ncsu.edu}\thanks{
%Alphabetical:
...
increasingly cite.
Replicability in computer science is no less important than in
...
However, the motivation for this policy is based on studies
``primarily in the biomedical field'' because so few
studies exist in computer science.
...
improve the state of reproducibility by forming
