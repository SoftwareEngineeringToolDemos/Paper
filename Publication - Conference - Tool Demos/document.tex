...
\newcommand{\durationTotal}{6362.5\xspace}
...
\newcommand{\emailsSent}{3.5\xspace}
\newcommand{\emailsRecieved}{2\xspace}
\newcommand{\durationAuthorResponse}{20\xspace}
\newcommand{\durationAuthorResponseCountHigh}{20\xspace}
\newcommand{\emailsHelpful}{84\%\xspace}
\newcommand{\emailsFriendly}{85\%\xspace}
\newcommand{\emailsIntimidating}{5\%\xspace}
\newcommand{\emailsAnnoyed}{10\%\xspace}
\newcommand{\emailsPercentSent}{94\%\xspace}
\newcommand{\contactOSSed}{1\xspace}
...
\newcommand{\papersWithLinks}{60\%\xspace}
\newcommand{\papersWithLinksDead}{8\%\xspace}
\newcommand{\papersWithLinksRevived}{44\%\xspace}
\newcommand{\obtainPaper}{41\%\xspace}
\newcommand{\obtainGoogle}{16\%\xspace}
\newcommand{\obtainEmail}{22\%\xspace}
\newcommand{\obtainNot}{22\%\xspace}
\newcommand{\onlineGitHub}{22\%\xspace}
\newcommand{\onlineSourceforge}{3\%\xspace}
\newcommand{\onlineGcode}{2\%\xspace}
\newcommand{\onlinePersonalSite}{26\%\xspace}
\newcommand{\onlineNotAvail}{42\%\xspace}
\newcommand{\onlineCodeplex}{2\%\xspace}
\newcommand{\onlineBitbucket}{3\%\xspace}
\newcommand{\onlineJustGcode}{2\xspace}
\newcommand{\working}{58\%\xspace}
\newcommand{\workingNum}{76\xspace}
\newcommand{\totalToolsTried}{131\xspace}
...
\newcommand{\unworkCouldntWorkIt}{17\xspace}
\newcommand{\serviceRunning}{8\xspace}
\newcommand{\serviceRunningLater}{2\xspace}
\newcommand{\serviceRunningNever}{4\xspace}
\newcommand{\redistPermissionArtifact}{37\xspace}
\newcommand{\redistPermissionEmail}{30\xspace}
\newcommand{\licenseMIT}{6\xspace}
\newcommand{\licenseGPL}{4\xspace}
\newcommand{\licenseApache}{6\xspace}
\newcommand{\licenseGPLThree}{3\xspace}
\newcommand{\licenseBSD}{6\xspace}
\newcommand{\licenseLGPL}{2\xspace}
\newcommand{\licenseMPL}{2\xspace}
\newcommand{\licenseEPL}{10\xspace}
\newcommand{\depWindows}{20\xspace}
\newcommand{\depVS}{6\xspace}
\newcommand{\permissionToRedistribute}{44\xspace}
...
\author{\IEEEauthorblockN{Emerson Murphy-Hill, Sumeet Agarwal, Bhanu Anand, Rishi Anne, Varun Aettapu, Ankit Bhandari,\\Dwayne Brown,Peter Chen, Joseph Decker, Sarah Elder, Mohammed Hassan, Sujith Katakam,\\Asish Prabhakar Kottala, Sai Sindhur Malleni, Apoorv Mahajan, Justin Middleton,\\Yashwanth Nallabothu, Gargi Rajadhyaksha, Manish Singh, Esha Sharma, Sindhu Vairavel}\\
\IEEEauthorblockA{Department of Computer Science\\
North Carolina State University\\
Raleigh, North Carolina, USA\\
emerson@csc.ncsu.edu, \{sagarwa6,bhanua,raanne,vaettap,abhanda3,dcbrow10,pmchen,jdecker,seelder,mhhassan,\\skataka,akottal,smallen3,amahaja3,jamiddl2,ynallab,gsrajadh,mrsingh,esharma2,sanangu\}@ncsu.edu}}
...
support and guidelines researchers need for increasing trialability.
...
The department has a specialty MS degree
track in software 
engineering~\cite{mstrack},
which requires this course.
...
In total, we collected 188 papers.
...
excessively pestering the researchers.
...
In practice, students marked enough tools as unworkable that we could
examine all tools presented through 2011, and even a few tools
from 2010.
We exclude tools from 2010 from our analysis presented in this paper
because we did not analyze all tools from 2010 nor did we select
a random sample.
These tools from 2010 are present, however, in our GitHub repository
and in our released virtual machines.  
...
Some tasks that were easy to do in a hand-built 
...
peers and by teachers' assistants (TAs).
...
in the repository's issue tracker and provided
...
acknowledments because they did not meet ACM authorship
...
When it came to obtaining the tools, \obtainPaper
...
The remaining tools were marked ``unworkable'' for
several reasons.
The most common 
...
\licenseLGPL with a LGPL 2.0 license, and
\licenseMPL with a Microsoft Public License.
Researchers added open source licenses to \contactOSSed tool
...
For instance, Microsoft provides some base boxes via
\url{aka.ms} links on \url{vagrantbox.es}.
%evidence all aka.ms links are ``official'': https://blogs.technet.microsoft.com/exchange/2011/07/22/navigating-exchange-content-like-a-pro-using-short-urls/ 
...
without also making the underlying software for 
...
are archived for posterity, even those from only a few years ago.
...
%What are the general patterns in what people are doing wrong, and
