...
They find that typically about half of the authors of accepted papers
...
Both aim to evaluate the artifacts' 
...
\begin{itemize}  
  \item The course did not have enough time to teach students
  		...
  		students, whom are non-thesis and industry-focused.   		 
...
running in VirtualBox on Windows 10. 
...
\textbf{In-Class Presentations.}
  	...
  	in class.
  	%DE students were required to make a video, or is this more focused on the in-class portion?
